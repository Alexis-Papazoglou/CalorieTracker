...
interface AuthContextProps {
    ...
    signUp: (email: string, password: string, username: string, bodyValues: {
        weight: number;
        height: number;
        age: number;
        ...
        timeGoal: string;
        gender: string;
    }, dailyCalories: number) => Promise<void>;
...
export function useAuth(): AuthContextProps {
    ...
    const signUp = async (email: string, password: string, username: string, bodyValues: {
        weight: number;
        height: number;
        age: number;
        trainingActivity: string;
