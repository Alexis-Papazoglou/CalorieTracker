...
async function imageCaloriesRequest({description, imageUrl}) {
    let prompt = `
    Task: The task is to analyze the image to identify food and drink items. For each identified item, provide its name, calorie count, fat content, and weight. Additionally, include a general title for the entire selection of food items.
